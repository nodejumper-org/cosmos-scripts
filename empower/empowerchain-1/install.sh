...
# todo: curl -s https://snapshots2.nodejumper.io/empowerchain/addrbook.json > $HOME/.empowerchain/config/addrbook.json
...
# TODO:
# SNAP_NAME=$(curl -s https://snapshots2.nodejumper.io/empower-testnet/info.json | jq -r .fileName)
