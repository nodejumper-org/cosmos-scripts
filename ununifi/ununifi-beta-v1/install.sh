...
curl -s https://snapshots.nodejumper.io/ununifi/addrbook.json > $HOME/.ununifi/config/addrbook.json
...
SNAP_NAME=$(curl -s https://snapshots.nodejumper.io/ununifi/info.json | jq -r .fileName)
