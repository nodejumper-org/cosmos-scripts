...
mkdir -p $HOME/go/bin
curl -L https://zetachain-external-files.s3.amazonaws.com/binaries/athens3/v8.1.0/zetacored-ubuntu-20-amd64 > $HOME/go/bin/zetacored
