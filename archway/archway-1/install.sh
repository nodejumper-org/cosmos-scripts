...
SNAP_NAME=$(curl -s https://snapshots.nodejumper.io/archway/info.json | jq -r .fileName)
curl "https://snapshots.nodejumper.io/archway/${SNAP_NAME}" | lz4 -dc - | tar -xf - -C "$HOME/.archway"
