...
# TODO: curl -s https://snapshots2-testnet.nodejumper.io/composable-testnet-3/addrbook.json > $HOME/.banksy/config/addrbook.json
...
#curl "https://snapshots2-testnet.nodejumper.io/composable-testnet/${SNAP_NAME}" | lz4 -dc - | tar -xf - -C "$HOME/.banksy"
