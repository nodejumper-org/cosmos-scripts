...
sed -i 's|^pruning-interval *=.*|pruning-interval = "17"|g' $HOME/.Cardchain/config/app.toml

sed -i 's|^minimum-gas-prices *=.*|minimum-gas-prices = "0.001ubpf"|g' $HOME/.Cardchain/config/app.toml
